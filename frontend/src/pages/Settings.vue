<template>
  <AppLayout>
    <div class="flex-1 flex flex-col overflow-hidden bg-gray-50 dark:bg-gray-900 transition-colors">
      <!-- Main Content -->
        ...
        <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div v-if="successMessage" class="mb-6 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
            <div class="flex items-center gap-2">
              <CheckCircleIcon class="h-5 w-5 text-green-600 dark:text-green-400 flex-shrink-0" />
          ...
          <div v-if="errorMessage" class="mb-6 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
            <div class="flex items-start gap-2">
              ...
              <div class="flex-1">
                ...
                <p v-if="rateLimitRetryAfter" class="text-xs text-red-700 dark:text-red-300 mt-1">
          ...
          <!-- Email Sync Section -->
          <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 mb-6 transition-colors">
            <div class="px-6 py-5 border-b border-gray-200 dark:border-gray-700">
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Email Sync</h2>
              <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
              ...
              <div>
                <div class="flex items-center justify-between mb-4">
                  ...
                  <span 
                    ...
                    class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-medium bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-800"
                  >
                  ...
                  <span 
                    ...
                    class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-medium bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-300 border border-green-200 dark:border-green-800"
                  >
                  ...
                  <span 
                    ...
                    class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-medium bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-300 border border-red-200 dark:border-red-800"
                  >
                  ...
                  <span 
                    v-else 
                    class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-medium bg-gray-50 dark:bg-gray-700 text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-600"
                  >
                ...
                <div v-if="syncStatus === 'syncing' && progress" class="bg-blue-50 dark:bg-blue-900/10 rounded-lg p-4 mb-4">
                  <div class="flex items-center gap-3">
                    <div class="flex-1">
                      <p class="text-sm font-medium text-blue-900 dark:text-blue-100">Sync in progress</p>
                      <div class="flex items-center gap-4 mt-2 text-sm text-blue-700 dark:text-blue-300">
          ...
          <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 mb-6 transition-colors">
            <div class="px-6 py-5 border-b border-gray-200 dark:border-gray-700">
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Email Rules</h2>
              <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
          ...
          <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 transition-colors">
            <div class="px-6 py-5 border-b border-gray-200 dark:border-gray-700">
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Microsoft Account</h2>
              <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            ...
            <div class="px-6 py-5 space-y-6">
                ...
                <div class="flex items-start gap-4">
                  ...
                  <div 
                    :class="[
                      ...
                      isConnected && !isTokenExpired ? 'bg-green-100 dark:bg-green-900/20' : 
                      isConnected && isTokenExpired ? 'bg-yellow-100 dark:bg-yellow-900/20' : 
                  ...
                  <div class="flex-1 min-w-0">
                    ...
                    <div v-if="isConnected" class="mt-2 space-y-2">
                      ...
                      <div v-if="tokenExpiresSoon" class="flex items-start gap-2 mt-3 p-3 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
                        <ExclamationTriangleIcon class="h-5 w-5 text-yellow-600 dark:text-yellow-400 flex-shrink-0 mt-0.5" />
                        <div class="flex-1 min-w-0">
                          <p class="text-sm font-medium text-yellow-900 dark:text-yellow-200">Token expiring soon</p>
                      ...
                      <!-- Token Expired -->
                      <div v-else-if="isTokenExpired" class="flex items-start gap-2 mt-3 p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
                        <ExclamationCircleIcon class="h-5 w-5 text-red-600 dark:text-red-400 flex-shrink-0 mt-0.5" />
                        <div class="flex-1 min-w-0">
                          <p class="text-sm font-medium text-red-900 dark:text-red-200">Token expired</p>
                      ...
                      <!-- Token Status (Normal) -->
                      <div v-else class="text-xs text-gray-500 dark:text-gray-400 mt-2">
              ...
              <div class="pt-4 border-t border-gray-200 dark:border-gray-700 flex flex-wrap gap-3">
                ...
                <button
                  ...
                  class="inline-flex items-center gap-2 px-4 py-2 bg-white dark:bg-gray-800 border border-red-300 dark:border-red-800 text-red-700 dark:text-red-400 text-sm font-medium rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors"
                >
              ...
              <DialogPanel class="relative transform overflow-hidden rounded-lg bg-white dark:bg-gray-800 px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                ...
                <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse gap-3">
                  ...
                  <button
                    ...
                    class="mt-3 inline-flex w-full justify-center rounded-lg bg-white dark:bg-gray-700 px-4 py-2.5 text-sm font-semibold text-gray-900 dark:text-white shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:w-auto disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                  >
                    Cancel
                  </button>
                </div>
